...
/* Composite-specific implementation of the unit test method (previously OS_ApplicationStartup). See the cFE2cos docs for more information. */
void Composite_UT_osfile(void)
{
